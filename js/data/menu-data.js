/**
 * GREY CORNER — CATALOGUE MENU DATA (ES Module)
 * Pure FR / EN / DE / AR (Maroc 🇲🇦)
 */
...
export const menuData = [
    ...
    "items": [
      ...
      },
      {
        "name": {
          ...
          "de": "Hähnchenfleischbällchen mit Käse",
  ...
  },
  {
    ...
    "items": [
      {
        "name": {
          "fr": "PAVÉ DE SAUMON À LA PLANCHA ",
      ...
      {
        "name": {
          "fr": "BROCHETTES DE POULET MARINÉES  ",
          "en": "Marinated chicken skewers",
          "de": "Marinierte Hähnchenspieße",
      ...
      {
        "name": {
          "fr": "ÉMINCÉ DE POULET À LA CRÈME DE CHAMPIGNONS ",
          "en": "Sliced chicken in creamy mushroom sauce",
          "de": "Hähnchengeschnetzeltes in cremiger Champignonsauce",
    ...
    "items": [
      ...
      },
      {
        "name": {
          ...
          "de": "Hähnchen-Couscous mit Buttermilch",
    ...
    "items": [
      ...
      },
      {
        "name": {
          ...
          "de": "Hühnerstreifen-Sandwich mit Champignons",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "name": {
          "fr": "Crêpe POULET-CHAMPIGNON",
          "en": "CHICKEN-MUSHROOM Crêpe",
          "de": "HÄHNCHEN-PILZ Crêpe",
