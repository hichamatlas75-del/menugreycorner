...
if (backToTop) {
  window.addEventListener("scroll", () => {
    ...
    if (openDrawerElement) {
      const rect = openDrawerElement.getBoundingClientRect();
      // If the open drawer's header is near or above the viewport, show the floating close button
      if (rect.top < 50) {
    ...
    // Default fallback: hide close button, show back-to-top if scrolled past 400px
